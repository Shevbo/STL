...
// нужен вовсе.
//
// ponytail: окно — MSK-полночь, как у recon. QUIK считает ВМ от клиринга, и
// если он не совпал с полуночью, перенос сдвинется МЕЖДУ участниками, но не
// изменит сумму. Точный base появится, когда QLua начнёт слать SETTLEPRICE.
