...
<style>
  ...
  /* Высоту графиков больше не диктует CSS: её тянут мышкой за полосу под
     сеткой, и выбор запоминается (ChartsGrid, --mini-h). Прежнее правило было
     СИЛЬНЕЕ переменной и в полноэкранном режиме просто отменяло бы перетаскивание. */
