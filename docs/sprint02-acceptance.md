...
nСквозная приёмочная схема Sprint02 (фазы 1+2): от нулевого агента до первого live-ордера. Включает обе фазы, точки входа/выхода, ответственность по компонентам.
