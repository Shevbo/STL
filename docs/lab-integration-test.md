...
Пошаговый сценарий ручной приёмки лаборатории: создание STL-линка, заведение робота,
прогон бэктеста и деплой в бумагу. Отвечает на вопросы вида «как проверить, что
лаборатория собрана правильно», «какой порядок приёмки перед выкаткой робота», «что
должно быть готово до первого прогона» и «почему бэктест не стартует на чистой базе».
Относится к слою lab и backtest, а не к боевой торговле.
