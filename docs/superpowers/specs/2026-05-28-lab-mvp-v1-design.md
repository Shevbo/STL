...
Проектный документ лаборатории STL: что она делает, из каких витрин состоит и где
проходит граница между подбором параметров и реальной торговлей. Отвечает на вопросы
вида «зачем нужен LAB», «что входило в первую версию, а что сознательно отложено»,
«как связаны витрина живых роботов, браузер инструментов и стенд перебора». Термины,
которыми эту тему называют в работе: лаборатория, стенд, витрина роботов, бэктест-лаб,
перебор по сетке.
