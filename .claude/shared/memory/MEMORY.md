...
- [valley_spike: стена частоты](project_valley_spike.md) — лестница на средней до долины смерти: 0-5 сделок/квартал при «очень дальних», 6-29 при разрыве 25%, знак 2 из 4; ttl_bars нужен (снятие на первом баре = 0 наливов)
