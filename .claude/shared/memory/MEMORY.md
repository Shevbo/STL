...
- [Прокол: фейд теряет, зеркало плюсует](reference_impulse_fade_mirror.md) — impulse_fade на 6 ATR: фейд минус на 4/4, вход ПО проколу плюс 12/12 пар; узкий стоп не та область; проба в пунктах занижает комиссию RI
