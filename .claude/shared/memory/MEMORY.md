...
- [rich_fool: лестница фейда открытия](project_rich_fool.md) — спецификация оператора (вверх=шорт, d_coef, стоп за лестницей, запрет овернайта, 2ema-выход); три круга неверных реализаций, все прогоны до 12.09 недействительны
- [Фантом склейки и дрейф расписания](reference_splice_phantom_and_session_drift.md) — шов переката RI 01.07 −13% дал 96% «итога» лидера; час открытия НЕЛЬЗЯ зашивать (FORTS менялся внутри периода); кэш базовых кодов терял утреннюю сессию
