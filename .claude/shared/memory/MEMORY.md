...
- [rich_fool: гипотеза мертва](project_rich_fool.md) — предоткрытийная лестница пробоя; 0 из 2430 строк дают >=150 сделок, максимум 52 за полгода
- [Прокол: фейд теряет, зеркало было артефактом](reference_impulse_fade_mirror.md) — стоп-заявка по проколу наливалась ровно по уровню, win 0.92 испарился до 0.54; в зеркальном гейте стороны исполняются РАЗНЫМИ типами заявок
