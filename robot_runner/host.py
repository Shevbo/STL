...
# Сколько закрытых минуток уезжает в отчёт на мини-график панели. Панель даёт
# выбрать плотность 30..200 баров на свою ширину, поэтому шлём верхнюю границу,
# а сколько показать — режет STL по запросу панели. Отчёт уходит раз в 15 с,
# 200 баров это ~8 КБ на робота: гейтить надо тики и стаканы, а не это.
BARS_TAIL_N = 200
