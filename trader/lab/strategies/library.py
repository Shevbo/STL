...
def make_on_bar(rid: str):
    ...
    async def on_bar(stl: STLRuntime, params: dict) -> None:
        ...
        _room = avg_max - abs(cur) if _add_max != 2 else 10 ** 9
...
SHECTORY1_PARAMS = [
    ...
    P("flip_add_max", "На убыточном развороте один раз долить следующей ступенью: 0=выкл, 1=в пределах потолка, 2=СВЕРХ потолка", 0, 0, 2),
