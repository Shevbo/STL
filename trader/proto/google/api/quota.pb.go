...
type MetricRule struct {
	...
	MetricCosts   map[string]int64 `protobuf:"bytes,2,rep,name=metric_costs,json=metricCosts,proto3" json:"metric_costs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type QuotaLimit struct {
	...
	Values map[string]int64 `protobuf:"bytes,10,rep,name=values,proto3" json:"values,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
const file_google_api_quota_proto_rawDesc = "" +
	"\n" +
	"\x16google/api/quota.proto\x12\n" +
	"google.api\"r\n" +
	"\x05Quota\x12.\n" +
	"\x06limits\x18\x03 \x03(\v2\x16.google.api.QuotaLimitR\x06limits\x129\n" +
	"\fmetric_rules\x18\x04 \x03(\v2\x16.google.api.MetricRuleR\vmetricRules\"\xb4\x01\n" +
	"\n" +
	"MetricRule\x12\x1a\n" +
	"\bselector\x18\x01 \x01(\tR\bselector\x12J\n" +
	"\fmetric_costs\x18\x02 \x03(\v2'.google.api.MetricRule.MetricCostsEntryR\vmetricCosts\x1a>\n" +
	"\x10MetricCostsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\x83\x03\n" +
	"\n" +
	"QuotaLimit\x12\x12\n" +
	"\x04name\x18\x06 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12#\n" +
	"\rdefault_limit\x18\x03 \x01(\x03R\fdefaultLimit\x12\x1b\n" +
	"\tmax_limit\x18\x04 \x01(\x03R\bmaxLimit\x12\x1b\n" +
	"\tfree_tier\x18\a \x01(\x03R\bfreeTier\x12\x1a\n" +
	"\bduration\x18\x05 \x01(\tR\bduration\x12\x16\n" +
	"\x06metric\x18\b \x01(\tR\x06metric\x12\x12\n" +
	"\x04unit\x18\t \x01(\tR\x04unit\x12:\n" +
	"\x06values\x18\n" +
	" \x03(\v2\".google.api.QuotaLimit.ValuesEntryR\x06values\x12!\n" +
	"\fdisplay_name\x18\f \x01(\tR\vdisplayName\x1a9\n" +
...
var (
	...
	file_google_api_quota_proto_rawDescData []byte
)

func file_google_api_quota_proto_rawDescGZIP() []byte {
	file_google_api_quota_proto_rawDescOnce.Do(func() {
		file_google_api_quota_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_api_quota_proto_rawDesc), len(file_google_api_quota_proto_rawDesc)))
	})
	return file_google_api_quota_proto_rawDescData
}

var file_google_api_quota_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_api_quota_proto_goTypes = []any{
...
func file_google_api_quota_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_api_quota_proto_rawDesc), len(file_google_api_quota_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
