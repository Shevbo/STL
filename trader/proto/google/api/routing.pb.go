...
const file_google_api_routing_proto_rawDesc = "" +
	"\n" +
	"\x18google/api/routing.proto\x12\n" +
	"google.api\x1a google/protobuf/descriptor.proto\"Z\n" +
	"\vRoutingRule\x12K\n" +
	"\x12routing_parameters\x18\x02 \x03(\v2\x1c.google.api.RoutingParameterR\x11routingParameters\"M\n" +
	"\x10RoutingParameter\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12#\n" +
	"\rpath_template\x18\x02 \x01(\tR\fpathTemplate:T\n" +
	"\arouting\x12\x1e.google.protobuf.MethodOptions\x18\xb1ʼ\" \x01(\v2\x17.google.api.RoutingRuleR\aroutingBj\n" +
	"\x0ecom.google.apiB\fRoutingProtoP\x01ZAgoogle.golang.org/genproto/googleapis/api/annotations;annotations\xa2\x02\x04GAPIb\x06proto3"

var (
	file_google_api_routing_proto_rawDescOnce sync.Once
	file_google_api_routing_proto_rawDescData []byte
)

func file_google_api_routing_proto_rawDescGZIP() []byte {
	file_google_api_routing_proto_rawDescOnce.Do(func() {
		file_google_api_routing_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_api_routing_proto_rawDesc), len(file_google_api_routing_proto_rawDesc)))
	})
	return file_google_api_routing_proto_rawDescData
}

var file_google_api_routing_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_api_routing_proto_goTypes = []any{
...
func file_google_api_routing_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_api_routing_proto_rawDesc), len(file_google_api_routing_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 1,
			NumServices:   0,
