...
const file_google_api_visibility_proto_rawDesc = "" +
	"\n" +
	"\x1bgoogle/api/visibility.proto\x12\n" +
	"google.api\x1a google/protobuf/descriptor.proto\">\n" +
	"\n" +
	"Visibility\x120\n" +
	"\x05rules\x18\x01 \x03(\v2\x1a.google.api.VisibilityRuleR\x05rules\"N\n" +
	"\x0eVisibilityRule\x12\x1a\n" +
	"\bselector\x18\x01 \x01(\tR\bselector\x12 \n" +
	"\vrestriction\x18\x02 \x01(\tR\vrestriction:d\n" +
	"\x0fenum_visibility\x12\x1c.google.protobuf.EnumOptions\x18\xafʼ\" \x01(\v2\x1a.google.api.VisibilityRuleR\x0eenumVisibility:k\n" +
	"\x10value_visibility\x12!.google.protobuf.EnumValueOptions\x18\xafʼ\" \x01(\v2\x1a.google.api.VisibilityRuleR\x0fvalueVisibility:g\n" +
	"\x10field_visibility\x12\x1d.google.protobuf.FieldOptions\x18\xafʼ\" \x01(\v2\x1a.google.api.VisibilityRuleR\x0ffieldVisibility:m\n" +
	"\x12message_visibility\x12\x1f.google.protobuf.MessageOptions\x18\xafʼ\" \x01(\v2\x1a.google.api.VisibilityRuleR\x11messageVisibility:j\n" +
	"\x11method_visibility\x12\x1e.google.protobuf.MethodOptions\x18\xafʼ\" \x01(\v2\x1a.google.api.VisibilityRuleR\x10methodVisibility:e\n" +
	"\x0eapi_visibility\x12\x1f.google.protobuf.ServiceOptions\x18\xafʼ\" \x01(\v2\x1a.google.api.VisibilityRuleR\rapiVisibilityBn\n" +
	"\x0ecom.google.apiB\x0fVisibilityProtoP\x01Z?google.golang.org/genproto/googleapis/api/visibility;visibility\xf8\x01\x01\xa2\x02\x04GAPIb\x06proto3"

var (
	file_google_api_visibility_proto_rawDescOnce sync.Once
	file_google_api_visibility_proto_rawDescData []byte
)

func file_google_api_visibility_proto_rawDescGZIP() []byte {
	file_google_api_visibility_proto_rawDescOnce.Do(func() {
		file_google_api_visibility_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_api_visibility_proto_rawDesc), len(file_google_api_visibility_proto_rawDesc)))
	})
...
func file_google_api_visibility_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_api_visibility_proto_rawDesc), len(file_google_api_visibility_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 6,
			NumServices:   0,
