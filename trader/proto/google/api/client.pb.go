...
const file_google_api_client_proto_rawDesc = "" +
	...
	"\vPhpSettings\x12:\n" +
	"\x06common\x18\x01 \x01(\v2\".google.api.CommonLanguageSettingsR\x06common\"\xc5\x02\n" +
	"\x0ePythonSettings\x12:\n" +
	"\x06common\x18\x01 \x01(\v2\".google.api.CommonLanguageSettingsR\x06common\x12d\n" +
	"\x15experimental_features\x18\x02 \x01(\v2/.google.api.PythonSettings.ExperimentalFeaturesR\x14experimentalFeatures\x1a\x90\x01\n" +
	"\x14ExperimentalFeatures\x121\n" +
	"\x15rest_async_io_enabled\x18\x01 \x01(\bR\x12restAsyncIoEnabled\x12E\n" +
	"\x1fprotobuf_pythonic_types_enabled\x18\x02 \x01(\bR\x1cprotobufPythonicTypesEnabled\"J\n" +
	"\fNodeSettings\x12:\n" +
	...
	"\x12total_poll_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\x10totalPollTimeout\"4\n" +
	"\x18SelectiveGapicGeneration\x12\x18\n" +
	"\amethods\x18\x01 \x03(\tR\amethods*\xa3\x01\n" +
