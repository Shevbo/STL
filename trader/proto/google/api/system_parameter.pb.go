...
const file_google_api_system_parameter_proto_rawDesc = "" +
	"\n" +
	"!google/api/system_parameter.proto\x12\n" +
	"google.api\"I\n" +
	"\x10SystemParameters\x125\n" +
	"\x05rules\x18\x01 \x03(\v2\x1f.google.api.SystemParameterRuleR\x05rules\"n\n" +
	"\x13SystemParameterRule\x12\x1a\n" +
	"\bselector\x18\x01 \x01(\tR\bselector\x12;\n" +
	"\n" +
	"parameters\x18\x02 \x03(\v2\x1b.google.api.SystemParameterR\n" +
	"parameters\"v\n" +
	"\x0fSystemParameter\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1f\n" +
	"\vhttp_header\x18\x02 \x01(\tR\n" +
	"httpHeader\x12.\n" +
	"\x13url_query_parameter\x18\x03 \x01(\tR\x11urlQueryParameterBv\n" +
	"\x0ecom.google.apiB\x14SystemParameterProtoP\x01ZEgoogle.golang.org/genproto/googleapis/api/serviceconfig;serviceconfig\xa2\x02\x04GAPIb\x06proto3"

var (
	file_google_api_system_parameter_proto_rawDescOnce sync.Once
	file_google_api_system_parameter_proto_rawDescData []byte
)

func file_google_api_system_parameter_proto_rawDescGZIP() []byte {
	file_google_api_system_parameter_proto_rawDescOnce.Do(func() {
		file_google_api_system_parameter_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_api_system_parameter_proto_rawDesc), len(file_google_api_system_parameter_proto_rawDesc)))
	})
...
var file_google_api_system_parameter_proto_goTypes = []any{
...
func file_google_api_system_parameter_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_api_system_parameter_proto_rawDesc), len(file_google_api_system_parameter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
