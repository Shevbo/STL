...
type Service struct {
	...
	Publishing *annotations.Publishing `protobuf:"bytes,45,opt,name=publishing,proto3" json:"publishing,omitempty"`
	// Obsolete. Do not use.
	//
...
func (x *Service) GetPublishing() *annotations.Publishing {
	if x != nil {
		return x.Publishing
	}
	return nil
...
const file_google_api_service_proto_rawDesc = "" +
	"\n" +
	"\x18google/api/service.proto\x12\n" +
	"google.api\x1a\x15google/api/auth.proto\x1a\x18google/api/backend.proto\x1a\x18google/api/billing.proto\x1a\x17google/api/client.proto\x1a\x18google/api/context.proto\x1a\x18google/api/control.proto\x1a\x1egoogle/api/documentation.proto\x1a\x19google/api/endpoint.proto\x1a\x15google/api/http.proto\x1a\x14google/api/log.proto\x1a\x18google/api/logging.proto\x1a\x17google/api/metric.proto\x1a#google/api/monitored_resource.proto\x1a\x1bgoogle/api/monitoring.proto\x1a\x16google/api/quota.proto\x1a\x1cgoogle/api/source_info.proto\x1a!google/api/system_parameter.proto\x1a\x16google/api/usage.proto\x1a\x19google/protobuf/api.proto\x1a\x1agoogle/protobuf/type.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x8d\n" +
	"\n" +
	"\aService\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12.\n" +
	"\x13producer_project_id\x18\x16 \x01(\tR\x11producerProjectId\x12\x0e\n" +
	"\x02id\x18! \x01(\tR\x02id\x12(\n" +
	"\x04apis\x18\x03 \x03(\v2\x14.google.protobuf.ApiR\x04apis\x12+\n" +
	"\x05types\x18\x04 \x03(\v2\x15.google.protobuf.TypeR\x05types\x12+\n" +
	"\x05enums\x18\x05 \x03(\v2\x15.google.protobuf.EnumR\x05enums\x12?\n" +
	"\rdocumentation\x18\x06 \x01(\v2\x19.google.api.DocumentationR\rdocumentation\x12-\n" +
	"\abackend\x18\b \x01(\v2\x13.google.api.BackendR\abackend\x12$\n" +
	"\x04http\x18\t \x01(\v2\x10.google.api.HttpR\x04http\x12'\n" +
	"\x05quota\x18\n" +
	...
	"\acontext\x18\f \x01(\v2\x13.google.api.ContextR\acontext\x12'\n" +
	"\x05usage\x18\x0f \x01(\v2\x11.google.api.UsageR\x05usage\x122\n" +
	"\tendpoints\x18\x12 \x03(\v2\x14.google.api.EndpointR\tendpoints\x12-\n" +
	"\acontrol\x18\x15 \x01(\v2\x13.google.api.ControlR\acontrol\x12-\n" +
	"\x04logs\x18\x17 \x03(\v2\x19.google.api.LogDescriptorR\x04logs\x126\n" +
	"\ametrics\x18\x18 \x03(\v2\x1c.google.api.MetricDescriptorR\ametrics\x12X\n" +
	"\x13monitored_resources\x18\x19 \x03(\v2'.google.api.MonitoredResourceDescriptorR\x12monitoredResources\x12-\n" +
	"\abilling\x18\x1a \x01(\v2\x13.google.api.BillingR\abilling\x12-\n" +
	"\alogging\x18\x1b \x01(\v2\x13.google.api.LoggingR\alogging\x126\n" +
	"\n" +
	"monitoring\x18\x1c \x01(\v2\x16.google.api.MonitoringR\n" +
	"monitoring\x12I\n" +
	"\x11system_parameters\x18\x1d \x01(\v2\x1c.google.api.SystemParametersR\x10systemParameters\x127\n" +
	"\vsource_info\x18% \x01(\v2\x16.google.api.SourceInfoR\n" +
	"sourceInfo\x126\n" +
	"\n" +
	"publishing\x18- \x01(\v2\x16.google.api.PublishingR\n" +
	"publishing\x12C\n" +
	"\x0econfig_version\x18\x14 \x01(\v2\x1c.google.protobuf.UInt32ValueR\rconfigVersionBn\n" +
	"\x0ecom.google.apiB\fServiceProtoP\x01ZEgoogle.golang.org/genproto/googleapis/api/serviceconfig;serviceconfig\xa2\x02\x04GAPIb\x06proto3"

var (
	file_google_api_service_proto_rawDescOnce sync.Once
	file_google_api_service_proto_rawDescData []byte
)

func file_google_api_service_proto_rawDescGZIP() []byte {
	file_google_api_service_proto_rawDescOnce.Do(func() {
		file_google_api_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_api_service_proto_rawDesc), len(file_google_api_service_proto_rawDesc)))
	})
	return file_google_api_service_proto_rawDescData
}

var file_google_api_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_api_service_proto_goTypes = []any{
	...
	(*annotations.Publishing)(nil), // 21: google.api.Publishing
...
var file_google_api_service_proto_depIdxs = []int32{
	...
	21, // 20: google.api.Service.publishing:type_name -> google.api.Publishing
	22, // 21: google.api.Service.config_version:type_name -> google.protobuf.UInt32Value
...
func file_google_api_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_api_service_proto_rawDesc), len(file_google_api_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
