...
CHECKLIST: list[dict] = [
    ...
    {"id": "chart_live_default", "n": 1,
     "text": "Главный график при загрузке показывает ЖИВОЙ контракт (RIU6/SiU6/…), не пустой."},
    ...
    {"id": "book_no_flicker", "n": 9,
     "text": "Стакан QUIK-инструмента (SRU6/BRU6): цифры не прыгают, спрэд стабильный (нет мигания Finam↔QUIK)."},
