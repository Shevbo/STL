...
AVG_PARAM_KEYS = {"avg_max", "avg_step_atr", "tp_atr", "sl_frac", "sl_pct", "avg_atr_n",
                  ...
                  # Расписание сторон внутри дня: пять осей, которые в обычной
                  # кампании умножили бы сетку в сотни раз. Осмысленны только на
                  # выделенном прогоне «нужно ли роботу расписание» — тогда их
                  # освобождают явно через --pin или явными paramSets.
                  "tod_m1", "tod_m2", "tod_s1", "tod_s2", "tod_s3",
                  # Пропуск сигналов после крупной сделки — та же логика: три оси,
                  # осмысленные только на выделенном прогоне райдера.
                  "signals2ignor_win", "signals2ignor_lose", "signals2ignor_value",
                  # Гейт режима рынка — та же логика: три оси, осмысленные
                  # только на выделенном прогоне, в общей кампании они лишь
                  # умножают сетку.
                  "reg_n", "reg_band", "reg_mode"}
