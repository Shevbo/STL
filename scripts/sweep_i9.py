...
# По ОДНОМУ ликвидному инструменту на тарифную группу MOEX (валюта / индекс / товар /
# акция): ставка биржевого сбора отличается втрое между группами, и именно она решает,
# выживет ли конфигурация. Панель узкая осознанно — бюджет 1 час CPU i9, юнит ~110 с,
# 10 воркеров: 64 комбинации × 4 инстр. = 256 юнитов ≈ 47 минут. BR/BM исключены, их
