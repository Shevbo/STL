...
AXES = {
    # коэффициент к D: 5 = 0.05×amp (сверхузкая лестница), 100 = 1.00×amp.
    # Нижняя граница опущена до 0.05 по указанию оператора. Проба показала, что
    # интересная область именно узкая: при 1.0 всего 1-7 сделок за квартал.
...
# Чанк: контракт × invert × hold_min -> 7·3·4·3·3·3 = 2268 paramSets в задании.
