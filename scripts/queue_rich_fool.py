...
CONTRACTS = [
    ...
    # ВНЕ ВЫБОРКИ отбора rf10: ликвидный квартал каждого прошлого контракта.
...
# rf11 = та же сетка rf10 на RIZ5/RIH6. Лидер rf10 вне выборки: RIZ5 фейд +21k против
# зеркала −92k, RIH6 фейд −5k против +67k. Смотрим долю векторов, переживших новые
# кварталы, а не одного лидера.
WAVE = "rf11"
ONLY = ("RIZ5", "RIH6")
