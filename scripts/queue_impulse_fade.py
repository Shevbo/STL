...
ВОЛНЫ imf5, imf5oos, imf6, imf6oos (13.09) ТОЖЕ НЕДЕЙСТВИТЕЛЬНЫ, и фейд, и пробой. Их
код наливал пробой внутри бара по уровню (у живого раннера стоп-заявок нет), а гейт
скорости мерил ход до экстремума того же бара — заглядывал в будущее. Отбор imf5 при
этом «пережил» четыре квартала вне выборки с перестановкой p<0.001: систематический
артефакт исполнения устойчив во всех кварталах так же, как эдж. На честном исполнении
(ea4d054) проба лидеров — отказ по обеим сторонам. Гипотеза закрыта.
