...
непустого code_sha в i9_heartbeat, совпадающего с отпечатком репозитория. Отпечаток
считать на ХОСТЕРЕ (Linux, LF): Windows-копия хранит файлы с CRLF, и её отпечаток не
совпадёт никогда — 13.09 это выглядело как отставание i9, которого не было.
